  ...
  return (
    <div className="container">
      <div className="card">
          ...
          <tbody>
            {drives.map(d => (
              <tr key={d._id}>
                ...
                <td>
                  <div className="row">
                    <Link className="btn secondary" to={`/drives/${d._id}`}>View</Link>
        ...
        {role === "student" ? <div style={{ marginTop: 10 }}><Link className="btn secondary" to="/student/drives">My Drive Registrations</Link></div> : null}
      </div>
    </div>
  );
}
